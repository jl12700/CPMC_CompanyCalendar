...
export default function UserTopBar() {
  ...
  return (
    <header className="fixed top-0 left-56 right-0 h-16 bg-gradient-to-r from-white to-gray-50 border-b border-gray-200 shadow-sm z-40 backdrop-blur-sm bg-opacity-95">
